    ...
    <div className='w-full h-screen text-right'>
      ...
      <div className='absolute top-0 w-full h-full flex flex-col justify-center text-orange-100'>
        <div className='md:right-[10%] max-w-[1100px] m-auto absolute p-4'>
          ...
          <p className='max-w-[440px] drop-shadow-2xl py-6 text-xl'>املاک دهکده با ده سال سابقه درخشان آماده است تا بهترین ملک را به توجه به نیاز شما تهیه کند. سرمایه گذاری در ملک تا به حال کسی را نا امید نکرده است</p>
          <button className= ' bg-orange-100 text-black font-bold '> بازدید </button>
        </div>
      </div>
    </div>
  )
